...
RUN wget -q http://dl.google.com/linux/chrome/deb/pool/main/g/google-chrome-stable/google-chrome-stable_143.0.7499.192-1_amd64.deb
RUN apt-get install -y ./google-chrome-stable_143.0.7499.192-1_amd64.deb
